...
public class MaquinaDeTuring {
    ...
    public boolean AgregarEstado(String newState) {
    ...
    public boolean EstadoInicial(String newStartState) {
    ...
    public boolean EstadoAceptacion(String newAcceptState) {
    ...
    public boolean EstadoNoAceptado(String newRejectState) {
    ...
    public boolean AgregarTransicion(String rState, char rSymbol, String wState, char wSymbol, boolean mDirection) {
